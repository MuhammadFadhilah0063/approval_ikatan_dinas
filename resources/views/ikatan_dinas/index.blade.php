            ...
            <div class="col">
              <div class="form-group">
                ...
                <span style="display: block; font-size: 12px; font-weight: 500; margin-top: 7px;">
                  Format file excel :&nbsp;
                  <a href="/assets/img/format/export.png" class="btn btn-sm btn-danger p-0 text-white" target="_blank"
                    style="padding: 1.6px 13px !important; font-size: 12px; font-weight: 500;">Lihat
                    Format</a>&nbsp;
                  <a href="/assets/excel/contoh.xlsx" class="btn btn-sm btn-danger p-0 text-white" target="_blank"
                    style="padding: 1.6px 13px !important; font-size: 12px; font-weight: 500;">Contoh File</a>
                </span>
              </div>
            </div>
          </div>
...
<script>
  $(document).ready(function() {
            ...
            success: function(response) {
              ...
              if (response.status == "success") {
                ...
                $(".invalid-feedback").remove();
                  ...
                  $("#modalEdit input[name='kode_ikatan_dinas']").val(response.data.kode_ikatan_dinas);
                  $("#modalEdit input[name='nrp_peserta']").val(response.data.nrp_peserta);
                  $("#modalEdit input[name='nama_peserta']").val(response.data.nama_peserta);
                  $("#modalEdit select[name='departemen']").val(response.data.departemen);
                  $("#modalEdit input[name='nama_pelatihan']").val(response.data.nama_pelatihan);
                  $("#modalEdit input[name='waktu_pelatihan']").val(response.data.waktu_pelatihan);
                  $("#modalEdit input[name='biaya_pelatihan']").val(response.data.biaya_pelatihan);
                  $("#modalEdit input[name='lama_ikatan_dinas']").val(response.data.lama_ikatan_dinas);
                  $("#modalEdit input[name='tgl_selesai_ikatan_dinas']").val(response.data.tgl_selesai_ikatan_dinas);
    ...
    $('#modalImport').on('hidden.bs.modal', function() {
      ...
      // Menghapus kelas is-valid dari setiap elemen input dan select dalam formulir
      $(".needs-validation-import :input, .needs-validation-import select").removeClass("is-valid");
      $(".needs-validation-import :input, .needs-validation-import select").removeClass("is-invalid");
      $(".invalid-feedback").remove();

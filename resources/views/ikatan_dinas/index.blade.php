                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <span style="display: block; font-size: 12px; font-weight: 500; margin-top: 7px;">
                                        Format file excel :&nbsp;
                                        <a href="/assets/img/format/export.png"
                                            class="btn btn-sm btn-danger p-0 text-white" target="_blank"
                                            style="padding: 1.6px 13px !important; font-size: 12px; font-weight: 500;">Lihat
                                            Format</a>&nbsp;
                                        <a href="/assets/excel/contoh.xlsx" class="btn btn-sm btn-danger p-0 text-white"
                                            target="_blank"
